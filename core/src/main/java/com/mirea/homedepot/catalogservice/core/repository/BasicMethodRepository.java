...
public interface BasicMethodRepository<E> {
     ...
     */
    E findById(@RequestParam("id") Long id);
     ...
     * @return список объектов класса Entity
     */
    List<E> findByListId(@RequestParam("listId") List<Long> listId);
     ...
     */
    Boolean insert(@RequestParam("entity") E entity);
     ...
     * @return результат операции
     */
    Boolean insertList(@RequestParam("entityList") List<E> entityList);
     ...
     * @return результат операции
     */
    Boolean update(@RequestParam("entity") E entity);
