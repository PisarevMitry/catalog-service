...
public class ProductFeedbackServiceImpl implements ProductFeedbackService {
    ...
    public List<Dto> findAll() {
        List<Entity> productFeedbackEntityList = productFeedbackRepository.findAll();
        return SelectorDto.mapFromEntity().select(productFeedbackEntityList, ProductFeedbackDtoDefault.class);
    }

    @Override
    public Dto findById(Long productFeedbackId) {
        Entity productFeedbackEntity = productFeedbackRepository.findById(productFeedbackId);
        return SelectorDto.mapFromEntity().select(productFeedbackEntity, ProductFeedbackDtoDefault.class);
    }

    @Override
    public List<Dto> findByListId(List<Long> listId) {
        List<Entity> productFeedbackEntityList = productFeedbackRepository.findByListId(listId);
        return SelectorDto.mapFromEntity().select(productFeedbackEntityList, ProductFeedbackDtoDefault.class);
    }

    @Override
    public void insert(Dto productFeedbackDto) {
        Entity productFeedbackEntity = SelectorEntity.mapFromDto().select(productFeedbackDto, ProductFeedbackEntity.class);
    ...
    public void insertList(List<Dto> productFeedbackDtoList) {
        List<Entity> productFeedbackEntityList = SelectorEntity.mapFromDto().select(productFeedbackDtoList, ProductFeedbackEntity.class);
    ...
    public List<Dto> findTreeIterationByParentId(Long id) {
        List<Entity> productFeedbackEntityList = productFeedbackRepository.findTreeIterationByParentId(id);
        return SelectorDto.mapFromEntity().select(productFeedbackEntityList, ProductFeedbackDtoDefault.class);
    }

    @Override
    public List<Dto> findTreePathByParentId(Long id) {
        List<Entity> productFeedbackEntityList = productFeedbackRepository.findTreePathByParentId(id);
        return SelectorDto.mapFromEntity().select(productFeedbackEntityList, ProductFeedbackDtoDefault.class);
    }
}
