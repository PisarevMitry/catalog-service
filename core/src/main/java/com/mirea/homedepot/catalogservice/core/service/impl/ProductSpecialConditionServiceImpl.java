...
public class ProductSpecialConditionServiceImpl implements ProductSpecialConditionService {
    ...
    public ProductSpecialConditionServiceImpl(ProductSpecialConditionRepository productSpecialConditionRepository,
    ...
    public List<ProductSpecialConditionDto> findAll() {
        ...
        return productSpecialConditionEntityList.stream()
                .map(el -> modelMapper.map(el, ProductSpecialConditionDtoDefault.class)).collect(Collectors.toList());
    }

    @Override
    public ProductSpecialConditionDto findById(Long productSpecialConditionId) {
        ProductSpecialConditionEntity productSpecialConditionEntity =
                productSpecialConditionRepository.findById(productSpecialConditionId);
    ...
    public void insert(ProductSpecialConditionDto productSpecialConditionDto) {
        ProductSpecialConditionEntity productSpecialConditionEntity =
                modelMapper.map(productSpecialConditionDto, ProductSpecialConditionEntity.class);
    ...
    public void insertList(List<ProductSpecialConditionDto> productSpecialConditionDtoList) {
        List<ProductSpecialConditionEntity> productSpecialConditionEntityList = productSpecialConditionDtoList.stream()
                .map(el -> modelMapper.map(el, ProductSpecialConditionEntity.class)).collect(Collectors.toList());
